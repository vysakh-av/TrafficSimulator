...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle) {
    ...
    if (_trafficLightObj.getCurrentPhase() == TrafficLightPhase::red) {
        _trafficLightObj.waitForGreen();
    }
...
bool Intersection::trafficLightIsGreen() {
    ...
    if (_trafficLightObj.getCurrentPhase() == TrafficLightPhase::green)
        return true;
    else
        return false;
